...
using SpireSolver.SpireSolverCode.Extensions;
using MegaCrit.Sts2.Core.Entities.Powers;

namespace SpireSolver.SpireSolverCode.Powers;
...
/// </summary>
public abstract class SpireSolverPower : CustomPowerModel
{
    //Loads from SpireSolver/images/powers/your_power.png
